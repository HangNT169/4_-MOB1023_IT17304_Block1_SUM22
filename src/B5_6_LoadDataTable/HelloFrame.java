...
public class HelloFrame extends javax.swing.JFrame {
    ...
    public HelloFrame() {
        ...
        // add data cho list
        listNhanViens.add(new NhanVien("ten1", "Loai 1", true, "An"));
        listNhanViens.add(new NhanVien("ten2", "Loai 2", false, "An Lan"));
        listNhanViens.add(new NhanVien("ten3", "Loai 1", true, "An"));
        listNhanViens.add(new NhanVien("ten4", "Loai 3", false, "Lan"));
        listNhanViens.add(new NhanVien("ten5", "Loai 1", true, "An"));

        String[] headers = {"Ten", "Loai", "GioiTinh", "SoThich"};
        dtm.setColumnIdentifiers(headers);

        // show data len table
        showDataTable(listNhanViens);
        
        // fill phan tu dau tien
...
//        this.dispose();// close 1 
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        NhanVien nhanVien = listNhanViens.get(row); // lay ra gia tri cua mang 
        txtName.setText(nhanVien.getTen());

    }//GEN-LAST:event_jTable1MouseClicked

    private void showDataTable(List<NhanVien> lists) {
        dtm.setRowCount(0); // xet table ve 0
